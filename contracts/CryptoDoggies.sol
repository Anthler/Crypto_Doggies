...
import "./ERC721/AccessControl.sol";
import "./ERC721/DoggyERC721.sol";
...
contract CryptoDoggies is AccessControl, DetailedERC721 {
    ...
    function createToken(string _name, address _owner, uint256 _price) public  onlyCLevel{
        require(_owner != address(0), "Owner address can't be 0");
        require(_price > startingPrice, "Price should be greater than starting price");

        //bytes5 _dna = _generateRandomDna();
        bytes5 _dna = 0x00000000;
